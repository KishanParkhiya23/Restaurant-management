        ...
        <div class="row no-gutters d-flex align-items-start align-items-center px-md-0">
            <div class="col-lg-12 d-block">
                <div class="row d-flex">
                    ...
                    <div>
                      {{-- <a href="{{ route('user.fprofile') }}"><i class="fa-solid fa-user" style="font-size: 16px;color:#c8a97e;margin-top:6px"></i></a> --}}
                      <a href=""><img src="{{ asset('client_side\images\user.png') }}" style="height: 30%" class="user-pic"></a>
                    </div>
                </div>
            </div>
        </div>
