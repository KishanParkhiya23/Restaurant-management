...
<div class="container">
    ...
    <div class="tab-content" id="pills-tabContent p-3">
        <div class="container my-5">
            <form action="{{route('user.save-order',2)}}" method="POST">
                @csrf
                <div class="d-flex">
                    <div style="flex: 4;">
                        <ul class="nav nav-pills mb-3 shadow-sm my-4 p-2" style="width: 93%;" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link " id="pills-delivery-tab" href="{{route('user.delivery')}}">Delivery</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-takeaway-tab" href="{{route('user.take-away')}}">Takeaway</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-table-tab" href="{{route('user.ontableorder')}}">On table order</a>
                            </li>
                        </ul>
                        <div class="tab-pane fade position-relative show active" id="pills-takeaway" role="tabpanel" aria-labelledby="pills-takeaway-tab">
                            <label>
