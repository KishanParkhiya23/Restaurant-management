                                ...
                                <div class="col-md-3 {{ $loop->last || $loop->first ? 'd-none' : '' }}">
                                    <div class="featured-menus ftco-animate">
                                        <div class="menu-img img"
                                            style="background-image: url({{ asset(isset($item['image']) ? $item['image'] : 'client_side/images/menu/no-menu-image.jpg') }});">
                                        </div>
            ...
            <div class="row">
                <div class="col-md-7 d-flex">
                    <div class="img img-1 mr-md-2"
                        style="background-image: url({{ asset('client_side/images/about.jpg') }});"></div>
                    <div class="img img-2 ml-md-2"
                        style="background-image: url({{ asset('client_side/images/about-1.jpg') }});"></div>
                </div>
                ...
                @foreach ($menu as $item)
                    <div class="col-md-12 col-lg-6 d-flex align-self-stretch">
                        <div class="menus d-sm-flex ftco-animate align-items-stretch">
                            <div class="menu-img img {{ $loop->iteration % 4 == 3 || $loop->iteration % 4 == 0 ? 'order-md-last' : '' }}"
                                style="background-image: url({{ asset(isset($item['image']) ? $item['image'] : 'client_side/images/menu/no-menu-image.jpg') }});">
                            </div>
                    ...
                    <div class="carousel-testimony owl-carousel ftco-owl">
                        <div class="item">
                            <div class="testimony-wrap text-center pb-5">
                                ...
                                <div class="text p-3">
                                    <p class="mb-4">“Everyone loved the hotel and the food. Sam and Dan were very impressed in what a very well oiled machine you run!”</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap text-center pb-5">
                                ...
                                <div class="text p-3">
                                    <p class="mb-4">“We received everyone was impressed and you will be on the top of our list for our next meeting in New Orleans.”</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap text-center pb-5">
                                ...
                                <div class="text p-3">
                                    <p class="mb-4">“Thank you for everything—All the Hotel Monteleone staff are amazing and we really appreciate the help and level of service.”</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap text-center pb-5">
                                ...
                                <div class="text p-3">
                                    <p class="mb-4">“The banquet managers were wonderful, especially Dennis. They met our every need in a timely manner.”</p>
                        ...
                        <div class="item">
                            <div class="testimony-wrap text-center pb-5">
                                ...
                                <div class="text p-3">
                                    <p class="mb-4">“The rooms were clean, very comfortable, and the staff was amazing. They went over and beyond to help make our stay enjoyable.”</p>
