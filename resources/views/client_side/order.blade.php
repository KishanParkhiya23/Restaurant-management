            ...
            <div class="row no-gutters slider-text align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate text-center mb-4">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('home') }}">Home <i
                                    class="ion-ios-arrow-forward"></i></a></span> <span>Add to cart <i
                    ...
                    <form action="{{route('user.addtocart')}}" method="post">
                        ...
                        <p>{{$item['poppings']}}</p>
                            ...
                            <div class="mt-5 text-right">
                                <a href="{{ route('user.menu') }}" class="btn btn-secondary w-100"
                                    style="border-radius: 0!important;height: 3rem;padding-top:0.7rem;">Cancel</a>
                                <button type="submit" class="btn btn-primary w-100 mt-2"
                                    style="border-radius: 0!important;height: 3rem;"><i class="fa-solid fa-cart-plus"
                                        style="margin-right: 0.8rem;"></i>Add to cart</button>
                            </div>
                        </form>
                    </div>
                </div>
