...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Menu /</span> Drinks
</h4>
<!-- Basic Bootstrap Table -->
<div class="card">
    <div class="card-header">
        <h5 class="d-inline-block">Drinks Menu</h5>
        <a href="{{ route('admin.menu.add.food.show',4) }}" class="btn rounded-pill  btn-primary float-end" style="padding: 0.6rem 0.9rem;"><i class="fa-solid fa-plus"></i></a>
    </div>
            ...
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        location.replace('/admin/menu/drinks');
                    }
                })
            }
        });
